...
{
    float cm, inches;
    std::cout << "Enter a length in cm : ";//printf("Enter a length in cm : ");
    std::cin >> cm;//scanf("%f",&cm);
    inches = cm / 2.54;
    std::cout << "Length in inches is " << inches << std:: endl;//printf("Length in inches is %f \n", inches);
    return 0;
}  
